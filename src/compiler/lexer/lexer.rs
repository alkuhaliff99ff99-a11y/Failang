...
impl Lexer {
    ...
    pub fn scan_tokens(mut self) -> Result<Vec<Token>, LexError> {
        // سيتم تفعيل حلقة الفحص الكاملة في الجزء الرابع والأخير
        Ok(self.tokens)
    }
    ...
    pub fn string_literal(&mut self) -> Result<(), LexError> {
        ...
        // استخراج النص البرميجي النظيف بدون علامات الاقتباس
    ...
    pub fn identifier(&mut self) {
        ...
        // فحص ما إذا كانت الكلمة مفتاحية محجوزة أم اسم معرف عادي
    ...
    // مساعدات التحقق من طبيعة الأحرف لدعم الـ Unicode كاملاً
    ...
    // دوال إنشاء وإضافة التوكنز إلى المصفوفة
